...
public class EffCopyFile extends Effect {
    ...
    public String toString(Event e, boolean debug) {
        return "copy file " + sourceFile.toString(e, debug) + " to " + destinationFile.toString(e, debug);
    }
    ...
    protected void execute(Event e) {
        ...
        if (source != null && destination != null) {
            try {
                java.nio.file.Files.copy(java.nio.file.Paths.get(source), java.nio.file.Paths.get(destination));
